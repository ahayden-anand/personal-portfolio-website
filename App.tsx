...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 selection:bg-accent/30 selection:text-accent font-sans transition-colors duration-500">
      ...
      {/* Hero Section */}
      <header id="hero" className="pt-28 pb-24 px-6 max-w-6xl mx-auto">
        <div className="flex flex-col-reverse lg:flex-row gap-16 items-center">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg md:text-2xl text-zinc-900 dark:text-zinc-100 mb-2 leading-relaxed max-w-2xl font-semibold">
              {PERSONAL_INFO.role}
            </p>
            <p className="text-sm md:text-base text-zinc-600 dark:text-zinc-400 mb-10 leading-relaxed max-w-2xl">
              Intern @ Inkflow Creative | Ex-Intern @ RoboAiQ | CSE Undergrad @ Karunya University | Programming & Problem-Solving
            </p>
            <p className="text-lg md:text-xl text-zinc-700 dark:text-zinc-300 mb-10 leading-relaxed max-w-2xl font-medium">
              <span className="text-zinc-900 dark:text-zinc-200">{PERSONAL_INFO.valueProp}</span>
            </p>
            ...
            <div className="flex flex-wrap gap-6 justify-center lg:justify-start mt-10">
              <a href="https://www.linkedin.com/in/hayden-anand" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 hover:text-accent transition-colors group">
                <div className="p-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-900 group-hover:bg-accent/10 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                </div>
                <span className="text-sm font-semibold">LinkedIn</span>
              </a>
              
              <a href="https://github.com/ahayden-anand" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 hover:text-accent transition-colors group">
                <div className="p-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-900 group-hover:bg-accent/10 transition-colors">
              ...
              <a href="https://www.credly.com/users/a-hayden-anand" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 hover:text-accent transition-colors group">
                <div className="p-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-900 group-hover:bg-accent/10 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 0c6.627 0 12 5.373 12 12s-5.373 12-12 12S0 18.627 0 12 5.373 0 12 0m2.5 18h-1.8v-5.4h1.8v5.4m-5.1 0h-1.8v-5.4h1.8v5.4m6.6-7.2c0-1.32-1.08-2.4-2.4-2.4s-2.4 1.08-2.4 2.4 1.08 2.4 2.4 2.4 2.4-1.08 2.4-2.4m-6 0c0-1.32-1.08-2.4-2.4-2.4s-2.4 1.08-2.4 2.4 1.08 2.4 2.4 2.4 2.4-1.08 2.4-2.4"/></svg>
                </div>
                <span className="text-sm font-semibold">Credly</span>
              </a>
              
              <a href={`mailto:${PERSONAL_INFO.email}`} className="flex items-center gap-2 text-zinc-600 dark:text-zinc-400 hover:text-accent transition-colors group">
                <div className="p-2.5 rounded-lg bg-zinc-100 dark:bg-zinc-900 group-hover:bg-accent/10 transition-colors">
        ...
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-4 gap-12 relative z-10">
          <div className="md:col-span-2 space-y-6">
            ...
            <p className="text-zinc-500 max-w-sm leading-relaxed font-medium">
               Building intelligent systems and scalable digital experiences. I am eager to grow as a developer, collaborate with like-minded professionals, and contribute meaningfully to innovative and impactful projects.
